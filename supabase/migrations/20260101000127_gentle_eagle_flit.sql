CREATE OR REPLACE FUNCTION public.get_admin_member_competence_balances(_group_id uuid, _competence_key text)
 RETURNS TABLE(user_id uuid, previous_debt numeric, current_cycle_owed numeric, current_cycle_paid numeric, accrued_debt numeric)
 LANGUAGE sql
 SECURITY DEFINER
