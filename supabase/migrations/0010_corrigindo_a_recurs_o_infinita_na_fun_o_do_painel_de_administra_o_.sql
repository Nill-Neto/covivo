-- Drop the temporary test function
DROP FUNCTION IF EXISTS get_admin_test_value();

-- Recreate the main function with SECURITY DEFINER to bypass recursive RLS policies
-- and add an explicit authorization check.
