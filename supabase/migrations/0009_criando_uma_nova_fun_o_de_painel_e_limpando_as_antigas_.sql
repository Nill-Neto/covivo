-- Drop the problematic and temporary functions
DROP FUNCTION IF EXISTS get_admin_dashboard_data(uuid, text);
DROP FUNCTION IF EXISTS get_admin_dashboard_data_v2(uuid, text);
DROP FUNCTION IF EXISTS get_admin_test_value();

-- Create a new, clean function with the correct logic
