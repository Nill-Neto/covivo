-- Drop any previous versions of the function to ensure a clean state
...
-- Recreate the function with the correct signature and SECURITY INVOKER
...
RETURNS uuid
LANGUAGE plpgsql
SECURITY INVOKER -- This is the key change to fix the permission issue correctly
SET search_path TO 'public'
AS $$
DECLARE
  _expense_id uuid;
  _caller_id uuid := auth.uid(); -- This will now work correctly
  _member record;
