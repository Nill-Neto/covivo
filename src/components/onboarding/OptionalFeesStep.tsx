...
import type { FeeEntry } from "./MandatoryFeesStep";
...
export function OptionalFeesStep({
  ...
  return (
    <OnboardingShell
      ...
      title="Taxas Extras Opcionais"
      description="Taxas cobradas apenas dos moradores que optarem por utilizar determinados serviços ou equipamentos coletivos (ex: lavanderia, academia). O morador escolherá nas suas configurações. Você pode pular e configurar depois."
    >
        ...
        {fees.map((fee, idx) => (
          <div key={idx} className="flex flex-col gap-2 rounded-lg border p-3">
            <div className="flex items-center gap-2">
              <Input
                placeholder='Ex: "Uso da lavanderia"'
                value={fee.title}
