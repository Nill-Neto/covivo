  ...
  const {
    ...
    queryFn: async () => {
      ...
      const tasks: AdminFetchTask[] = [
        ...
        { key: "profiles", source: "get_group_member_public_profiles", critical: true, run: async () => supabase.rpc("get_group_member_public_profiles", { _group_id: membership.group_id }) },
